...
TRAINING_ITERATIONS = 5500

#LOAD_FROM = '/home/paperspace/Desktop/testing/src/save/2017-8-23-8-8-world-1-1-iter-{}.pickle'.format(i)
LOAD_FROM = '/home/paperspace/Desktop/testing/src/save/2017-8-23-8-8-world-1-1-iter-1.pickle'
...
if AGENT_TYPE == ApproxQAgent or AGENT_TYPE == ApproxSarsaAgent:
...
K = 0 # k value for exploration function, should be a float; set to 0 to ignore
